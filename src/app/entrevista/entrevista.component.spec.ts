...
describe('Entrevistas', () => {
  ...
  beforeEach(async () => {
    TestBed.configureTestingModule({
      declarations: [EntrevistaComponent, AppNavigationFakeComponent],
      imports: [
        HttpClientModule,
        RouterTestingModule,
  ...
  it('Aplicar filtro en entrevistas', () => {
    ...
    expect(component.entrevistaDataSource.filter).toBe('filtro');
  });
